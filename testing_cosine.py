...
# It uses train_similar_not_similar_combined.csv, which is basically an updated version of train_myversion.csv formed
# after removing the UnicodeDecodeError-causing characters in train_not_similar.csv,
# as in the pics titled "Error in row x of train_not_similar.csv"
